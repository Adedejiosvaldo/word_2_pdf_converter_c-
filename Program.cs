...
Console.WriteLine("    POST /api/convert            - Convert single file to PDF");
Console.WriteLine("    POST /api/convert/download    - Convert and download PDF");
Console.WriteLine("    POST /api/convert/batch       - Convert multiple files to PDF");
Console.WriteLine("    POST /api/convert/batch/download - Convert multiple, download ZIP");
